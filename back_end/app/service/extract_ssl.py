...
class ExtractSSL:
    ...
    def __init__(self, url: str):
        ...
        # Get automatic certificate retrieval
        self._fetch_certificate()

    def _fetch_certificate(self):
        """Fetch SSL certificate information and store it in self.info"""
        if not self.hostname:
            self.info = {"error": "Invalid URL or hostname not found."}
            return

        try:
            # Connexion securization 
            ...
            # Extraction of principal information
